...
import dictionary.TrigramDictionary;

public class TrigramFitnessFunction extends AbstractFitnessFunction {

	private TrigramDictionary dictionary;
	
	public TrigramFitnessFunction() {
		dictionary = TrigramDictionary.getInstance();
	}
